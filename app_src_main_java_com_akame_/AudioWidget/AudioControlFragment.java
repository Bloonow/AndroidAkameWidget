package com.excelbloonow.android.musicplayer.AudioWidget;
...
//                    mMediaPlayer.seekTo(position);
        ...
        mTimeProportionText = view.findViewById(R.id.id_audio_time_proportion_text);
        mTimeProportionText.setText(timeProportion());

        mBackwardButton = view.findViewById(R.id.id_audio_backward_button);
        mPlayPauseButton = view.findViewById(R.id.id_audio_play_pause_button);
        mForwardButton = view.findViewById(R.id.id_audio_forward_button);
